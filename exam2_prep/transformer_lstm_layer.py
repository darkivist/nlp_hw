...
class TransformerLSTM(torch.nn.Module):
    def __init__(self, vocab_size, embedding_dim, transformer_dim, hidden_dim, num_layers, num_heads):
        ...
        self.fc = torch.nn.Linear(hidden_dim, 1)  # Binary classification
...
model = TransformerLSTM(vocab_size, embedding_dim, transformer_dim, hidden_dim, num_layers, num_heads)
